    ...
    <main className="app">
      ...
      <section className="client-info-wrapper">
        ...
        <div className="client-info-container">
          ...
          <div className="client-info-steps-settings">
            <h2 className="client-info-settings-title">Client Settings</h2>
            <p className="client-info-settings-instructions">
          ...
          <div className="client-info-steps-commands">
            <h2 className="client-info-commands-title">Client Commands</h2>
